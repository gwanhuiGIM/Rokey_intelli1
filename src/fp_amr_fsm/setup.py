...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/launch', ['launch/fleet.launch.py']),
        ('share/' + package_name + '/config', ['config/fleet_params.yaml']),
    ],
    ...
    entry_points={
        'console_scripts': [
            # waypoint_patrol/patrol_fsm/amr_agent/amr_patrol_emer_helmet 는
            # 이 패키지에 소스가 없어 ros2 run 시 깨지므로 entry point 제거.
